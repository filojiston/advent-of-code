...
public class Graph<T> {
    ...
    /**
     * Add new edge between vertex. Adding new edge from u to v will automatically add new edge from
     * v to u since the graph is undirected.
     *
    ...
    /**
     * Remove the edge between vertex. Removing the edge from u to v will automatically remove the
     * edge from v to u since the graph is undirected.
     *
     * @param v Start vertex.
     * @param u Destination vertex.
     */
